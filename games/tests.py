...
class PlayerTest(APITestCase):
    ...
    def test_create_duplicated_played(self):
        """
        Ensure we can create a newPlayer and we cannot create a duplicate
        """
        url = reverse('player-list')
...
class GameCategoryTest(APITestCase):
    def create_game_category(self, name):
        ...
        data = {'name': name}
        response = self.client.post(url, data, formar='json')
        return response
    ...
    def test_update_game_category(self):
        ...
        """
        new_game_category_name = 'Initial Game'
        response = self.create_game_category(new_game_category_name)
        url = reverse(
            'gamecategory-detail',
            None,
        ...
        updated_game_category_name = 'Initial Name'
